const books = [
	...
	},
	{
		...
		rated: 4.8,
		description: `Czy ludzie są świadomymi i autonomicznymi autorami własnych wyborów i osądów? Czy mogą ufać własnemu myśleniu, zwłaszcza temu szybkiemu - intuicyjnemu i emocjonalnemu? Rozważniej jest na pewno zdać się na myślenie wolne, analityczne. A mimo to trudno uniknąć pułapek myślenia.`,
	...
	},
	{
		...
		author: "Kim West",
		rated: 4.6,
		description: `Kim West, LCSW-C, known to her clients as The Sleep Lady(R), has developed an alternative and effective approach to helping children learn to gently put themselves to sleep without letting them "cry it out" -- an option that is not comfortable for many parents.`,
